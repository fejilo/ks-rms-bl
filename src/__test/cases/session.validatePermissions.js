...
(async () => {
  try {
    ...
    // console.log('Campaign Response:', session.auth.user.getCampaignById(10117).getPermissions());
    const hasPermissions = session.validatePermissions(['asset.order_item_update', 'rms.campaign_create']);
